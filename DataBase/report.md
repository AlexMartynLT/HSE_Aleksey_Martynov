...
1.	Описание задания
Спроектирована база данных для "Нового западного университета". База данных хранит информацию о студентах, преподавателях, предметах, группах и оценках. Реализована поддержка истории обучения, разделение предметов по типам и защита целостности данных.
...
В файле queries.sql представлены запросы согласно заданию. Сами запросы также приведены в приложении к настоящему отчету.
